...
Function/wave MEM_Igor8_ex(rawwv,xNum,yNum,axiswv,M,K_sq)
	...
	duplicate ramanshift_ei ramanshift_ei_in
	ramanshift_ei_in = -ramanshift_ei_in
	i=0
	do 
		MatrixOp/O/FREE tempwv = col(rawwv, i) 
		wave tempwv_ei = even_interval(tempwv,axiswv,ramanshift_ei)
		wave mem_wave = MEM_5_2(tempwv_ei, ramanshift_ei_in,M,K_sq)
		exp_wv[][i] = mem_wave[p]
		i+=1
...
Function darkNonres(rawwv, bgwv, nrwv)
	...
	matrixop/o tempnr = tempnr - tempbg
