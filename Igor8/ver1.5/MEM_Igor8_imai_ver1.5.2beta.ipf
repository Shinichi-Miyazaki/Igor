...
Threadsafe Function/wave MEM_Igor8_ex(rawwv,xNum,yNum,axiswv,M,K_sq)
	wave rawwv, axiswv
...
THreadsafe Function/wave MEM_5_2(pow_spectrum,ramanshift,M,K_sq)
...
Threadsafe Function background_value(ps_wv,ramanshift_wv)
...
Threadsafe Function/wave even_interval(CARSwv,rswv,rswv_ei)
