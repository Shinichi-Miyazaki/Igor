...
Function MEM_Igor8(rawwave, xNum, yNum, zNum, axiswave, M)
	wave rawwave, axiswave
	variable M, xNum, yNum, zNum
	...
	do
		...
		wave temp_imchi3 = MEM_igor8_ex(tempwave, xNum, yNum, axiswave, M)
...
Function/wave MEM_Igor8_ex(rawwv,xNum,yNum,axiswv,M)
	wave rawwv, axiswv
	...
	do 
		...
		wave mem_wave = MEM(tempwv_ei,ramanshift_ei,M)
		exp_wv[][i] = mem_wave[p]
		i+=1
